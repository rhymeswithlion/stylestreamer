...
# Absolute monorepo root so UI snapshot tests can write under output/ by default.
get_filename_component(MRT_MONOREPO_ROOT_FOR_TESTS "${CMAKE_CURRENT_SOURCE_DIR}/../.." ABSOLUTE)
# Quoted string token for C++ (paths may contain spaces).
target_compile_definitions(Tests PRIVATE "MRT_MONOREPO_ROOT_FOR_TESTS=\"${MRT_MONOREPO_ROOT_FOR_TESTS}\"")
...
# And give tests access to our shared code. Catch2 must come first so its
# headers win over any Homebrew include paths exported by native dependencies.
target_link_libraries(Tests PRIVATE Catch2::Catch2 SharedCode)
